...
export const LGA_BY_STATE = {
  Abia: ["Aba North", "Aba South", "Arochukwu", "Bende", "Ikwuano", "Isiala-Ngwa North", "Isiala-Ngwa South", "Isuikwato", "Obi Ngwa", "Ohafia", "Osisioma Ngwa", "Ugwunagbo", "Ukwa East", "Ukwa West", "Umuahia North", "Umuahia South", "Umu-Neochi"],
  ...
  "Cross River": ["Akpabuyo", "Odukpani", "Akamkpa", "Biase", "Abi", "Ikom", "Yarkur", "Odubra", "Boki", "Ogoja", "Yala", "Obanliku", "Obudu", "Calabar South", "Etung", "Bekwarra", "Bakassi", "Calabar Municipality"],
  Delta: ["Oshimili North", "Aniocha North", "Aniocha South", "Ika South", "Ika North-East", "Ndokwa West", "Ndokwa East", "Isoko South", "Isoko North", "Bomadi", "Burutu", "Ughelli South", "Ughelli North", "Ethiope West", "Ethiope East", "Sapele", "Okpe", "Warri North", "Warri South", "Uvwie", "Udu", "Warri Central", "Ukwani", "Oshimili South", "Patani"],
  Ebonyi: ["Edda", "Afikpo North", "Afikpo South", "Onicha", "Ohaozara", "Abakaliki", "Ishielu", "Ikwo", "Ezza North", "Ezza South", "Ohaukwu", "Ebonyi", "Ivo"],
  Edo: ["Esan North-East", "Esan Central", "Esan West", "Egor", "Ukpoba", "Central", "Etsako Central", "Igueben", "Oredo", "Ovia South-West", "Ovia South-East", "Orhionwon", "Uhunmwonde", "Etsako East", "Esan South-East"],
  Ekiti: ["Ado Ekiti", "Ekiti-East", "Ekiti-West", "Emure", "Ekiti South-West", "Ikere", "Irepodun/Ifelodun", "Ijero", "Ido/Osi", "Oye", "Ikole", "Moba", "Gbonyin", "Efon", "Ise/Orun", "Ilejemeje"],
  Enugu: ["Enugu South", "Igbo-Eze South", "Enugu North", "Nkanu East", "Udi", "Oji-River", "Ezeagu", "Igbo-Eze North", "Isi-Uzo", "Nsukka", "Igbo-Ekiti", "Uzo-Uwani", "Enugu East", "Aninri", "Nkanu West", "Udenu"],
  FCT: ["Abaji", "Abuja Municipal", "Bwari", "Gwagwalada", "Kuje", "Kwali"],
  Gombe: ["Akko", "Balanga", "Billiri", "Dukku", "Kaltungo", "Kwami", "Shomgom", "Funakaye", "Gombe", "Nafada", "Yamaltu/Deba"],
...
// States as dropdown options (alphabetically sorted, FCT shown as Abuja)
...
export function getLgaOptions(state) {
  ...
  return lgas.map((lga) => ({ value: lga, label: lga }));
}
